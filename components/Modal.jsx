...
function Modal() {
  ...
  let [open, setOpen] = useRecoilState(modalState)
    ...
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        ...
        <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 pb-20 px-4 text-center sm:block sm:p-0'>
          ...
          {/* to make the browser center center the modal */}
          <span
            className='hidden sm:align-middle sm:inline-block sm:h-screen'
            aria-hidden='true'>
            &#8203;
          </span>
          ...
          <Transition.Child
            ...
            <div className='inline-block align-bottom bg-white rounded-lg  px-4 pt-5 pb-4  text-left overflow-hidden shadow-xl  transform-trasition-all sm:my-8   sm:align-middle sm:max-w-xl  sm:w-full sm:p-6'>
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
